...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::kanban::project::KanbanProject::decl(),
        db::models::kanban::project::CreateKanbanProject::decl(),
        db::models::kanban::project::UpdateKanbanProject::decl(),
        db::models::kanban::status::KanbanProjectStatus::decl(),
        db::models::kanban::status::CreateKanbanProjectStatus::decl(),
        db::models::kanban::status::UpdateKanbanProjectStatus::decl(),
        db::models::kanban::issue::KanbanIssue::decl(),
        db::models::kanban::issue::KanbanIssuePriority::decl(),
        db::models::kanban::issue::CreateKanbanIssue::decl(),
        db::models::kanban::issue::UpdateKanbanIssue::decl(),
        db::models::kanban::issue::BulkUpdateKanbanIssueItem::decl(),
        db::models::kanban::tag::KanbanTag::decl(),
        db::models::kanban::tag::CreateKanbanTag::decl(),
        db::models::kanban::tag::UpdateKanbanTag::decl(),
        db::models::kanban::issue_tag::KanbanIssueTag::decl(),
        db::models::kanban::issue_tag::CreateKanbanIssueTag::decl(),
        db::models::kanban::issue_assignee::KanbanIssueAssignee::decl(),
        db::models::kanban::issue_assignee::CreateKanbanIssueAssignee::decl(),
        db::models::kanban::issue_relationship::KanbanIssueRelationship::decl(),
        db::models::kanban::issue_relationship::KanbanIssueRelationshipType::decl(),
        db::models::kanban::issue_relationship::CreateKanbanIssueRelationship::decl(),
