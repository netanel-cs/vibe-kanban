...
description: "Deploy Agent Kanban Cloud on any server using Docker Compose"
---

This guide covers deploying Agent Kanban Cloud on any Linux server using Docker Compose. This approach works with any cloud provider (AWS, DigitalOcean, Hetzner, etc.) or on-premises server.
...
Clone the Agent Kanban repository:
...
2. You should see the Agent Kanban Cloud login page
