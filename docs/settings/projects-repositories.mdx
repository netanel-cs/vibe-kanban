...
<Tip>
The dev server must output its URL (e.g., `http://localhost:3000`) to stdout for Agent Kanban to detect and display it in the preview panel.
</Tip>
...
Run your scripts manually in a terminal before configuring them in Agent Kanban to ensure they work correctly.
</Accordion>
</AccordionGroup>
