...
description: "Complete guide to all coding agents supported by Agent Kanban, including installation and authentication instructions"
---

Agent Kanban integrates with a variety of coding agents. Each agent requires installation and authentication before use. Select your preferred agent when creating task attempts.
