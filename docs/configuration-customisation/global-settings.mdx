...
<Frame>
<img src="/images/vk-settings.png" alt="Agent Kanban global settings page showing theme options, agent configuration, and settings" />
</Frame>
...
<Frame>
<img src="/images/vk-editor-ssh.png" alt="Agent Kanban settings editor section showing ssh configuration options." />
</Frame>
