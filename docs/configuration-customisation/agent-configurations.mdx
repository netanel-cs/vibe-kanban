...
<Info>
Agent profiles are used throughout Agent Kanban wherever agents run: onboarding, default settings, attempt creation, and follow-ups.
</Info>
...
<Note>
The configuration page displays the exact file path where your settings are stored. Agent Kanban saves only your overrides whilst preserving built-in defaults.
</Note>
...
<Card title="MCP Server Configuration" icon="server" href="/integrations/mcp-server-configuration">
  Configure MCP servers within Agent Kanban for your coding agents
</Card>

<Card title="Agent Kanban MCP Server" icon="plug" href="/integrations/vibe-kanban-mcp-server">
  Connect external MCP clients to Agent Kanban's MCP server
</Card>
</CardGroup>
