...
<Tip>
For detailed setup instructions and examples, see the [Agent Kanban MCP Server](/integrations/vibe-kanban-mcp-server) documentation.
</Tip>
...
The MCP client will automatically generate structured tasks in your Agent Kanban project based on this description.
