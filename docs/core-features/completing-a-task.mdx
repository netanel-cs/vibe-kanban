...
description: "Learn how to complete tasks by rebasing, merging, and managing pull requests directly from Agent Kanban"
sidebarTitle: "Completing a Task"
---

When your task is finished, Agent Kanban provides integrated git operations to keep your branch up-to-date and merge your work back into the base branch.
