...
description: "Connect to Azure Repos to create pull requests and manage your workflow directly from Agent Kanban"
---

Agent Kanban integrates with Azure Repos to let you create pull requests directly from your task attempts. This integration relies on the [Azure CLI (`az`)](https://learn.microsoft.com/en-us/cli/azure/) with the Azure DevOps extension being installed and authenticated on your system.

## Setup

Before you can create pull requests from Agent Kanban, you need to install and configure the Azure CLI manually.
...
Agent Kanban supports both modern and legacy Azure DevOps URL formats:
