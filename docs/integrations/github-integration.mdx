...
description: "Connect to GitHub to create pull requests and manage your workflow directly from Agent Kanban"
---

Agent Kanban integrates with GitHub to let you create pull requests directly from your task attempts. This integration relies on the [GitHub CLI (`gh`)](https://cli.github.com/) being installed and authenticated on your system.

## Setup

There is no need to configure GitHub in the Agent Kanban settings manually. The integration is designed to work out-of-the-box if you have the GitHub CLI installed.

### Automatic Setup
When you attempt to create your first Pull Request, Agent Kanban will check if the GitHub CLI is available. If it's not found or not authenticated, you will be guided through the setup process:
...
### Manual Setup
You can also set up the integration manually in your terminal before using Agent Kanban:
