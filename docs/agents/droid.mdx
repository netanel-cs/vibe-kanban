...
<Step title="Authenticate with Factory AI">
  To use Droid in Agent Kanban, you must first authenticate:
...
Droid supports several configuration options in Agent Kanban:
...
These options can be configured when creating agent configurations in Agent Kanban.
