...
## Authentication
Authenticate and configure CCR outside of Agent Kanban. Follow the instructions on the CCR GitHub repo:
...
## Configure Agent Kanban

Agent Kanban does not ship a default configuration for CCR. Add configurations to the existing Claude Code agent:
...
### Example: Claude Code agent configuration in Agent Kanban

<Frame>
<img src="/images/vk-ccr-agent-config.png" alt="Claude Code agent configuration in Agent Kanban" />
</Frame>

## Using CCR in Agent Kanban
