...
description: "Common issues and solutions when using Agent Kanban"
---

<img src="/images/brand/agent-kanban-mascot.png" alt="Agent Kanban mascot" style={{ width: '80px', marginBottom: '1rem' }} />
...
If you encounter irrecoverable errors and need to completely wipe your Agent Kanban database, you can delete the application data directory for your operating system. 
...
After deleting the application data directory, restart Agent Kanban to reset with an empty database and default settings.
