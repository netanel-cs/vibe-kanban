...
Agent Kanban creates a **git worktree** - a separate working directory with its own branch. This keeps your changes isolated from your main codebase. Your original repository remains untouched.
</Step>
...
3. Check that Agent Kanban has permission to access the folder
</Accordion>
